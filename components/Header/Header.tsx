import { CalculatorIcon, EnvelopeIcon, InformationCircleIcon, WrenchScrewdriverIcon } from '@heroicons/react/24/solid';
    ...
    <header className="text-ghost fixed top-0 z-50 flex w-full items-center justify-between bg-slate-950 p-4">
      ...
      <nav className="flex items-center gap-4 sm:gap-8" role="navigation" aria-label={t('label')}>
        ...
        <Link
          href="/pricing"
          className="rounded px-2 py-1 transition-colors hover:text-blue-400"
          aria-label={t('pricing_label')}>
          <CalculatorIcon className="h-5 w-5 md:hidden" aria-hidden="true" />
