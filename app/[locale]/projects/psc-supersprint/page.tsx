    ...
    <div className="text-ghost relative pt-10">
      <main className="m-auto flex max-w-7xl flex-col items-center gap-10 px-4 pb-4">
            ...
            <div className="space-y-4 text-gray-300">
              ...
              <ul className="grid gap-3 md:grid-cols-2">
                ...
                <li className="flex items-center gap-3">
                  ...
                  <span>{t('technology.stack.firebase')}</span>
                </li>
                <li className="flex items-center gap-3">
                  <span className="mt-1 h-2 w-2 flex-shrink-0 rounded-full bg-blue-800" aria-hidden="true"></span>
                  <span>{t('technology.stack.radix')}</span>
                </li>
                <li className="flex items-center gap-3">
                  <span className="mt-1 h-2 w-2 flex-shrink-0 rounded-full bg-blue-900" aria-hidden="true"></span>
                  <span>{t('technology.stack.testing')}</span>
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="w-full" aria-labelledby="purpose-heading">
          <div className="rounded-lg bg-slate-800 px-6 py-8 lg:p-8">
            <div className="mb-6 flex items-center gap-4">
              <TrophyIcon className="h-8 w-8 shrink-0 text-green-400" aria-hidden="true" />
